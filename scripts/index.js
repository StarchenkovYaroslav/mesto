...
const profileEditPopup = document.querySelector('.popup_content_edit-profile-info-form');
const newCardPopup = document.querySelector('.popup_content_add-new-card-form');
